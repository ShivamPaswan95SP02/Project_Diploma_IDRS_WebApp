...
<html>
    ...
    <body>
      ...
      <div class="carousel-caption">   
          <h1 style="font-size:50px;font-style:italic;">Indian Air Force</h1> 
    <div class="modal-dialog" id="ddl" onchange="get-val(); ">
         <div class="modal-content">
             <div class="modal-header">
                
      <form action="../IndianAF" method="post" enctype="multipart/form-data" style="background-color: yellowgreen;">
