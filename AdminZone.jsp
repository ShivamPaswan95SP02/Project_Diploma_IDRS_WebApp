...
<html>
    ...
    <body>
     ...
     font-size: 30px; background-image:linear-gradient(orangered,white,green);">
          ...
          <h1 style="font-size:50px;font-style:italic;">Welcome to Admin Zone</h1> 
                      </div>
                     </div>
...
<div class="row">
  ...
  <li class="active"> Admin Zone </li>
    ...
    <div class="col-sm-12" style=" height: 100%;">
        ...
        <div class="col-sm-10">
   <img src="../images/background1.jpg" alt="..." style="height:750px; width:100%;">
     
      <div class="carousel-caption">   
          
          <h1 style="font-size:40px;font-style:italic;color:blue; "> SHIVAM PASWAN </h1> 
           <table style="width: 100%;  color:white; font-size: 20px;">
               <tr>
              <th>Group Leader </th>
              </tr>
          <tr>
              <th>Full Name :- Shivam paswan</th>
              </tr>
              <tr>
              <th>Current  Address:- Mirzapur</th>
              </tr>
              <tr>
              <th>Mobile: +919628580738</th>
              </tr>
              <tr>
              <th>Email ID : shivampaswan2002@gmail.com</th>
              </tr>
              <tr>
              <th>Education :- DIPLOMA <BR> COMPUTER SCIENCE & ENGINEERING </th>
              </tr>
              
         
           </table>
          <br><br>
           <h1 style="font-size:40px;font-style:italic; color:red; "> ALOK KUMAR </h1> 
             <br><br>
           <table style="width: 100%;  color:white; font-size: 20px;">
          <tr>
              <th>Full Name :-ALOK KUMAR</th>
              </tr>
              <tr>
              <th>Current  Address:- Mirzapur</th>
              </tr>
              <tr>
              <th>Mobile: +919565498730</th>
              </tr>
              <tr>
              <th>Email ID : alokkumar1234@gmail.com</th>
              </tr>
              <tr>
              <th>Education :- DIPLOMA <BR> COMPUTER SCIENCE & ENGINEERING </th>
              </tr>
