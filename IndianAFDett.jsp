...
<html>
    ...
    <body>
     ...
     font-size: 30px; background-image:linear-gradient(orangered,white,green);">
          ...
          <h1 style="font-size:50px;font-style:italic;"> Indian Air Force all fighter jet </h1> 
                      </div>
                     </div>
...
<div class="row">
  ...
  <li class="active"> Indian Air Force</li>
</ol>
</div>
    </div>
    ...
    <div class="col-sm-12" style=" height: auto; background-color:royalblue;">
       <br>
        <%
           ...
           String command="select*from indianforce ";
