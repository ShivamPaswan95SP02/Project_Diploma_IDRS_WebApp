...
<html>
    ...
    <body>
         <img src="../images/Indianregiment.JPG" alt="..." style="height: auto; width:100%;">
    ...
    <div class="modal-dialog" id="ddl" onchange="get-val(); ">
      ...
      <form action="../IndianAdb" method="post" enctype="multipart/form-data" style="background-color: yellowgreen;">
